<script lang="ts">
	...
	import { initializePartyKitSync, partyKitSync as partyKitSyncStore } from '$lib/partykit-sync-store.svelte';
	import type PartyKitSync from '$lib/partykit-sync'; // Ensure this path is correct and PartyKitSync is the default export or a named export
